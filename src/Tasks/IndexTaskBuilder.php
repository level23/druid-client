...
class IndexTaskBuilder extends TaskBuilder
{
    ...
    /**
     * Set the input format. Either csv or json
     *
     * @var string
     */
    ...
    protected function buildTask($context): TaskInterface
    {
        ...
        if (empty($this->inputFormat) && $this->inputSource instanceof InlineInputSource) {
     ...
     * @return $this
     */
    public function inputFormat(string $inputFormat): IndexTaskBuilder
    {
